	...
	<div id="bg">
		<nav class="navbar navbar-nav navbar-dark bg-dark">
			<div class="container-fluid d-flex justify-content-between">
				...
				<a href="/login"><button type="button" class="btn btn-outline-light p-auto">Login</button></a>
			</div>
		</nav>
		<div id="main">
			<div class="container text-white">
				<div class="row">
                    <div class="col-md-12">
                        <h2 class="text-center mt-3">Unete a nuestra comunidad!</h2>
                    </div>
                </div>
                <form:form action="/confirmation" id="form" modelAttribute="elUser">
                    <div class="row mt-3">
